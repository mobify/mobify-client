...
var compile = dust.x.compile = function compile(ast, name) {
  var context = {
    name: name,
    bodies: [],
    blocks: {},
  ...
  // Accept '\' characters in template names.
  // Useful for templates named after Windows paths.
  name = name.replace(/\\/g, '\\\\');
...
var compileBlocks = dust.x.compileBlocks = function compileBlocks(context) {
  var out = [],
...
var compileBodies = dust.x.compileBodies = function compileBodies(context) {
  var out = [],
...
var compileParts = dust.x.compileParts = function compileParts(context, body) {
  var parts = '';
...
dust.compileNode = dust.x.compileNode = function(context, node) {
